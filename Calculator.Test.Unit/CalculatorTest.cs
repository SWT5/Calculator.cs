...
namespace Calculator.Test.Unit
{
    ...
    public class CalculatorTest
    {
        ...
        {
            Assert.That(uut.Add_1(2).Add_1(2).Accumulator, Is.EqualTo(5));
        }

        [Test]
        public void Add1_firstNegative_secondPositive_return1()
        {
            Assert.That(uut.Add_1(-2).Add_1(2).Accumulator, Is.EqualTo(1));
        }
        ...
        {
            Assert.That(uut.Add_1(-2).Add_1(-2).Accumulator, Is.EqualTo(-3));
        }
        ...
        {
            Assert.That(uut.Subract_1(5).Subract_1(4).Accumulator, Is.EqualTo(-8));
        }

        [Test]
        public void sub1_firstNegative_secondPositive_return2()
        {
            Assert.That(uut.Subract_1(-5).Subract_1(4).Accumulator, Is.EqualTo(2));
        }

        [Test]
        public void sub1_firstPositive_secondNegative_returnNegative0()
        {
            Assert.That(uut.Subract_1(5).Subract_1(-4).Accumulator, Is.EqualTo(0));
        }

        [Test]
        public void sub1_firstNegative_secondPositive_return10()
        {
            Assert.That(uut.Subract_1(-5).Subract_1(-4).Accumulator, Is.EqualTo(10));
        }
        ...
        {
            Assert.That(uut.Multiply(2).Multiply(2).Accumulator, Is.EqualTo(4));
        }
        [Test]
        ...
        {
            Assert.That(uut.Add_1(19).Divide(2).Divide(2).Accumulator, Is.EqualTo(5));
        }
        [Test]
        ...
        {
            Assert.That(uut.Add_1(1).Power_1(2).Power_1(2).Accumulator, Is.EqualTo(16));
        }

        [Test]
        public void pow_firstNegative_secondPositive_return00625()
        {
            Assert.That(uut.Add_1(1).Power_1(-2).Power_1(2).Accumulator, Is.EqualTo(0.0625));
        }
        [Test]
